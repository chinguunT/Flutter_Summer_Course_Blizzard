...
class FlexScreen extends StatelessWidget {
    ...
    return SizedBox(
      ...
      child: Row(
        children: [
          ...
          Expanded(child: LabeledContainer(color: Colors.purple, text: 'The Remainder', textColor: Colors.white,)),
  ...
  Widget _buildFlexible(BuildContext context){
    return SizedBox(
      ...
      child: Row(
        children: [
          Flexible(flex: 1, child: LabeledContainer(color: Colors.orange, text: '25%'),),
          Flexible(flex: 1, child: LabeledContainer(color: Colors.deepOrange, text: '25%'),),
          Flexible(flex: 1, child: LabeledContainer(color: Colors.blue, text: '50%'),),
        ],
      ),
    );
  }
    ...
    return Center(
      child: Container(
        ...
        child: Padding(
          ...
          child: Text('Pinned to the Bottom', style: Theme.of(context).textTheme.titleSmall,),
        ),
      ),
    );
  }
